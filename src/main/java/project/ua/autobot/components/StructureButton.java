...
import project.ua.autobot.interfaces.TypesRepos;
...
public class StructureButton extends TelegramLongPollingBot {
    ...
    private void sendTechManagement(long chatId) {
        ...
        sendMessage.setText(
            ...
            "3) Плавно попускаємо зчеплення і праву ногу ставимо на педаль акселератора (газ). Опускаючи зчеплення до " +
            "легенької вібрації, додаємо газу. І, як вже машина почала їхати, впевнено тиснемо газ, відпустивши плавно зчеплення.\n\n" +
            ...
            "легше їхати, а Вам вільно керувати цим всим та відчувати, що потребує Ваш ТЗ. Чи меншої передачі чи більшої швидкості і так далі. " +
            "Розігнавшись до 20 км/год, вже розуміємо що час перемикатися на більшу передачу.\n\n" +
            "Як це робиться під час ходу?\n\n" +
            "1) Знімаємо ногу з газу, а лише потім вижимаємо зчеплення. Коли так робимо, ми від'єднуємо двигун від трасмісії. " +
            "Тобто, якщо вижати зчеплення і паралельно тиснути на газ, то будемо чути харакерний звук " +
            ...
            "Ось як би і техніка керування машиною. Зараз я Вам запропоную декілька порад, " +
            "і якщо їх дотримуватися - керувати ТЗ буде в задоволення.\n\n" +
            ...
            "безпеку руху.\n\n" +
            "\uD83D\uDC49 _Не спішіть, бо встигнете._\nПомилка, що спіткає багатьох водіїв. І задля легкої та впевненої їзди " +
            "краще спокійно зосередитися на маневрі та плавно проїхати.\n\n" +
            "\uD83D\uDC49 _Впевнені на 101%? Проїжайте._\nДуже специфічна задача, коли їдете по населеному пункту, " +
            "а перед вами заморгав світлофор. Якщо він моргає перед Вами - проїжайте. Бувають випадки, " +
            "щоб уникнути ситуації на дорозі, і на жовте проїжають. Тому тут максимальна увага.\n\n" +
    ...
    private void sendBasicsManagement(long chatId) {
        ...
        sendMessage.setText(
            ...
            "надалі перемикати передачі, тиснути педалі, дивитися по дзеркалам " +
            "і так далі було без проблем та навантажень.\n\n" +
            "\uD83D\uDCCC Примітка. Ось цей порядок, який зараз буде написано, " +
            "ото в такому порядку і треба робити. Нічого не треба додумувати " +
            ...
            "❗️ Завдяки таким правилам розташування під відповідними кутами, " +
            ...
            "довше ніж 3 секунди. Це може вплинути на подальшу експлуатацію стартера.\n\n" +
    ...
    public void handleTextMessage(long chatId) {
        ...
        message.setText(
            ...
            Отже, перед вами є ці складові, що включають цей опис до кожної системи. Ви можете тиснути по кнопкам \
